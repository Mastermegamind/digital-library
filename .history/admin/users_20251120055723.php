...
<div class="page-header">
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
        ...
        <div class="d-flex gap-2">
            ...
            <a href="user_add.php" class="btn btn-success"><i class="fas fa-user-plus me-2"></i>Add User</a>
        </div>
    </div>
</div>
...
<div class="users-table-card">
    <?php if (empty($users)): ?>
        <div class="empty-state">
            ...
            <a href="user_add.php" class="btn btn-primary btn-lg"><i class="fas fa-user-plus me-2"></i>Add First User</a>
        </div>
    <?php else: ?>
                ...
                <tbody>
                    <?php foreach ($users as $u): ?>
                        <tr>
                            ...
                            <td class="text-end">
                                <a href="user_edit.php?id=<?= $u['id'] ?>" class="btn btn-sm btn-outline-secondary btn-action"><i class="fas fa-edit"></i></a>
                                <a href="user_delete.php?id=<?= $u['id'] ?>&csrf=<?= h($csrf) ?>"
