...
<div class="users-table-card">
    <?php if (empty($users)): ?>
        <div class="empty-state">
            ...
            <a href="user_add.php" class="btn btn-primary btn-lg">
                        ...
                        <tr>
                            <td>
                                <?php if (!empty($u['profile_image_path'])): ?>
                                    ...
                                    <img src="<?= h($avatarUrl) ?>" alt="Avatar" class="user-avatar">
                                <?php else: ?>
                            ...
                            <td>
                                ...
                                <div class="user-email">
                                    <i class="fas fa-envelope me-1"></i><?= h($u['email']) ?>
                                </div>
                            </td>
                            <td>
                                <span class="role-badge role-<?= h($u['role']) ?>">
                                    <i class="fas fa-<?= $u['role'] === 'admin' ? 'shield-alt' : 'user-graduate' ?> me-1"></i>
                                    <?= h(ucfirst($u['role'])) ?>
                                </span>
                            </td>
                            <td>
                            ...
                            <td class="text-end">
                                <a href="user_edit.php?id=<?= $u['id'] ?>" class="btn btn-sm btn-outline-secondary btn-action">
