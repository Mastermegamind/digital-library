...
<div class="page-header">
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
        ...
        <div class="d-flex gap-2">
            ...
            <a href="resource_add.php" class="btn btn-success">
...
<div class="resources-table-card">
    <?php if (empty($resources)): ?>
        <div class="empty-state">
            ...
            <a href="resource_add.php" class="btn btn-primary btn-lg">
                ...
                <tbody>
                    <?php foreach ($resources as $r): ?>
                        <tr>
                            ...
                            <td class="text-end">
                                <a href="../viewer.php?id=<?= $r['id'] ?>" class="btn btn-sm btn-primary btn-action" target="_blank">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="resource_edit.php?id=<?= $r['id'] ?>" class="btn btn-sm btn-outline-secondary btn-action">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <a href="resource_delete.php?id=<?= $r['id'] ?>&csrf=<?= h(get_csrf_token()) ?>"
