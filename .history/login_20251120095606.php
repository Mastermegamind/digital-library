...
<head>
    ...
    <style>
        ...
        body {
            ...
            background: url('<?= app_path('assets/images/login-bg.jpg') ?>') center/cover no-repeat fixed;
        }
        ...
        body::before {
            ...
            background: linear-gradient(135deg, 
                rgba(37, 99, 235, 0.78),   /* your primary blue */
                rgba(59, 130, 246, 0.68)); /* slightly lighter */
            pointer-events: none;
            z-index: 1;
        }
        ...
        @media (max-width: 480px) {
            ...
            .logo-circle img { width: 120px; height: 120px; }
        }
    </style>
</head>
<body>
