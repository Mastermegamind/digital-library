...
<?php elseif ($type === 'epub' && $fileUrl): ?>
    ...
    <div id="epub-reader" style="width:100%;height:100%;background:#fff;position:relative;">
        <div id="epub-loading" style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);text-align:center;">
            <p>Loading EPUB...</p>
        </div>
    </div>
